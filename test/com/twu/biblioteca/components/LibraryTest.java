...
public class LibraryTest {
    ...
    public void testProperty() {
        ...
        Assert.assertEquals(
            5,
            library.getAvailableItems(RentalItemType.BOOK).size()
        );
        ...
        Assert.assertEquals(
            5,
            library.getAvailableItems(RentalItemType.MOVIE).size()
        );
    }
    ...
    public void testGetItemByIdentifierMethod() throws RentalItemNotExistError {
        Assert.assertEquals(
            movies[0],
            library.getItemByIdentifier(
                RentalItemType.MOVIE,
                "A movie by A director, 1986"
            )
        );
        Assert.assertEquals(
            books[0],
    ...
    public void testCheckoutInvalidBookItemMethod()
        throws RentalItemNotExistError {
        library.checkout(new Book("H book", "H person", 2010));
    }

    @Test(expected = RentalItemNotExistError.class)
    public void testCheckoutInvalidMovieItemMethod()
        throws RentalItemNotExistError {
        library.checkout(
            new Movie("H movie", "H director", "drama", 2009, 2.4)
        );
    }

    @Test
    public void testReturnItemMethod()
    ...
    @Test(expected = RentalItemNotExistError.class)
    public void testReturnInvalidBookItemMethod()
        throws RentalItemNotExistError, RentalItemAlreadyExistError {
        library.checkout(books[0]);
        library.checkout(books[1]);
    ...
    @Test(expected = RentalItemAlreadyExistError.class)
    public void testReturnExistingBookItemMethod()
        throws RentalItemNotExistError, RentalItemAlreadyExistError {
        library.checkout(books[0]);
        library.returnItem(books[0]);
        library.returnItem(books[0]);
    ...
    @Test(expected = RentalItemNotExistError.class)
    public void testReturnInvalidMovieItemMethod()
        throws RentalItemNotExistError, RentalItemAlreadyExistError {
        library.checkout(movies[0]);
        library.checkout(movies[1]);
        library.returnItem(
    ...
    @Test(expected = RentalItemAlreadyExistError.class)
    public void testReturnExistingMovieItemMethod()
        throws RentalItemNotExistError, RentalItemAlreadyExistError {
        library.checkout(movies[0]);
        library.returnItem(movies[0]);
        library.returnItem(movies[0]);
