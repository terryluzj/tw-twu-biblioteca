...
import com.twu.biblioteca.component.item.Movie;
...
public class LibraryTest {
    ...
    @Test
    public void testAddRentalItemMethod() throws RentalItemAlreadyExistError {
        library.addItem(new Movie("Test movie", "Terry", "comedy", 2020, 10.0));
        library.addItem(new Book("H book", "H person", 2010));
    }
}
